  ...
  return (
    ...
    >
      <div className="relative flex h-full flex-col">
        <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-primary/12 via-primary/6 to-transparent">
          <Avatar className="h-16 w-16 shrink-0 border border-border shadow-sm ring-2 ring-background">
        ...
        <div className='flex flex-1 flex-col p-4 gap-2'>
          {user.badges && user.badges.length > 0 ? (
                <div className="hidden sm:flex truncate gap-1.5">
          ...
          {user.bio ? (
            <p className="hidden sm:line-clamp-2 text-[13px] leading-relaxed text-muted-foreground">
              {user.bio}
            </p>
          ) : null}

          {(user.skills && user.skills.length > 0) ? (
            <div className="hidden sm:flex min-h-7 flex-wrap gap-1.5 items-center">
          ...
          {!isOwnProfile ? (
            <div className="mt-auto flex items-center gap-2 sm:pt-2">
